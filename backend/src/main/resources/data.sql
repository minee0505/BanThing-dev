...
-- ============================================
-- comments 데이터 삽입 (참여한 사용자만 작성)
-- ============================================

INSERT INTO comments (user_id, meeting_id, content, is_deleted, created_at, updated_at) VALUES
-- 모임 1 (host: 김코스트, user_id: 1, 참여자: 4, 5, 6)
(1, 1, '안녕하세요! 호스트입니다. 오시는 길에 궁금한 점 있으시면 언제든 물어보세요!', FALSE, NOW(), NOW()),
(4, 1, '참여했습니다! 당일 모임 장소에서 뵙겠습니다.', FALSE, NOW(), NOW()),
(5, 1, '저도 참여합니다! 혹시 견과류 외 다른 상품도 소분 가능한가요?', FALSE, NOW(), NOW()),
(6, 1, '늦었지만 신청했습니다. 노쇼하지 않겠습니다!', FALSE, NOW(), NOW()),

-- 모임 2 (host: 이소분, user_id: 2, 참여자: 3)
(2, 2, '다우니 4L 소분 모임이에요. 1/3씩 나눠가질 예정이니 용기 미리 준비해주세요.', FALSE, NOW(), NOW()),
(3, 2, '확인했습니다! 정확한 위치는 어떻게 되나요?', FALSE, NOW(), NOW()),

-- 모임 3 (host: 박나눔, user_id: 3, 참여자: 7, 8)
(3, 3, '냉동식품 소분 모임입니다. 아이스팩도 미리 준비해오시면 좋아요.', FALSE, NOW(), NOW()),
(7, 3, '안녕하세요! 냉동만두 정말 좋아하는데 기대되네요.', FALSE, NOW(), NOW()),
(8, 3, '확정되었습니다! 덕분에 좋은 상품 소분해서 저렴하게 구매할 수 있겠네요.', FALSE, NOW(), NOW()),

-- 모임 5 (host: 정합리, user_id: 5, 참여자: 4)
(5, 5, '호스트입니다. 금일 예정된 모임은 정상 진행됩니다. 궁금한 점 댓글 주세요!', FALSE, NOW(), NOW()),
(4, 5, '참여합니다! 1인 가구에게 정말 유용한 서비스네요.', FALSE, NOW(), NOW()),

-- 모임 8 (host: 김코스트, user_id: 1, 참여자: 2, 3, 4, 5)
(1, 8, '오전 11시 코스트코에서 뵙겠습니다. 다들 늦지 않게 와주세요.', FALSE, NOW(), NOW()),
(2, 8, '안녕하세요 호스트님, 조금 늦을 것 같아요. 미리 양해 부탁드립니다.', FALSE, NOW(), NOW()),
(3, 8, '저도 참가합니다! 노쇼하지 않고 꼭 참여하겠습니다.', FALSE, NOW(), NOW()),
(5, 8, '모임 인원이 벌써 다 찼네요! 다들 감사드립니다.', FALSE, NOW(), NOW());
