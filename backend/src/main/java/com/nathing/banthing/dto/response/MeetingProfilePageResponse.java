...
/**
 * MeetingProfilePageResponse 클래스는 사용자의 특정 참여 상태 모임 정보를 페이징 처리하여
 * 응답으로 반환하기 위한 DTO(Data Transfer Object)입니다.
 *
 * 이 클래스는 모임 상세 정보 리스트, 페이지 번호, 페이지 크기,
 * 총 요소 수와 같은 페이징 관련 정보를 포함합니다.
 * 주로 Controller 계층에서 클라이언트로 반환할 응답 객체로 사용됩니다.
 *
 * 주요 역할:
 * - 사용자 특정 참여 상태 모임의 세부 정보를 페이지 단위로 제공.
